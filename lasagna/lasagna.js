...
export function preparationTimeInMinutes(numberOfLayers) {
  var totalPreparationTimeInMinutes = numberOfLayers * PREPARATION_MINUTES_PER_LAYER;
...
export function totalTimeInMinutes(numberOfLayers, actualMinutesInOven) {
  var totalPreparationTimeForAllLayers = preparationTimeInMinutes(numberOfLayers);
  var totalWorkingTime = totalPreparationTimeForAllLayers + actualMinutesInOven;

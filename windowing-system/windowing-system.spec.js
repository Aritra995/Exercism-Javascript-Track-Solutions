...
/* 
describe( 'Custom test of Move', () => {
  test('windows size 1000', () => {
    const programWindow = new ProgramWindow();
    const newPosition = new Position(710, 525);
    programWindow.move(newPosition);
    console.log(`Width before: ${programWindow.position.x}`);
    console.log(`Height before: ${programWindow.position.y}`);
    const newSize = new Size(1000, 1000);
    programWindow.resize(newSize);
    console.log(`Width: ${programWindow.position.x}`);
    console.log(`Height: ${programWindow.position.y}`);
